...
- **Recruiter**: Tu punto de contacto principal
...
4. **Explorar alternativas** - discutir trade-offs
5. **Probar código** - verificar manualmente con ejemplos
6. **Código de calidad** - limpio, eficiente, ejecutable
...
- **Lenguaje**: Dominar Python/Java/C++/Go/JS
...
2. Preguntar antes de codificar
3. Optimizar (no fuerza bruta)
...
- [ ] Preguntas clarificadoras repasadas
